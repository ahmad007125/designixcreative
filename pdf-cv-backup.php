...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    <head>
        ...
        <style>
            ...
            .profile-img img { max-width: 150px; border-radius: 50%; }
            @import url("https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;500;600;700;800&display=swap");
            table, body { font-family: "Open Sans", sans-serif; }
            .cv-container { max-width: 920px; margin: auto; background-color: #f4f5fc; border: 1px solid #dedee3; border-radius: 4px; overflow: hidden; color: #333; }
            .left-side { padding: 0; width: 30%; height: 100%; float: left; background-color: #f4f5fc; }
            .right-side { width: 70%; height: 100%; float: right; background-color: #fff; }
            ...
            .contact-info.all-content { padding: 15px; margin-top: 20px; width: 100%; height: 100%; }
            ...
            .cv-body-content { padding: 20px 20px 20px 32px; background-color: #fff; }
                ...
                <table cellpadding="0" cellspacing="0" style="">
                    <tr>
                        <td colspan="5" style="height: 250px; background-color: #f2f2f2;">
                            ' . (!empty($imageFilePath) ? '<img src="' . $imageFilePath . '" alt="Profile Image" width="30%" height="250px" style="max-width: 100%; object-fit: cover; object-position: center; background-color: #f2f2f2;">' : 'Nothing') . '
                        </td>
