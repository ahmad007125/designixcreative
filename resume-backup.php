...
<div class="container create-resume-container">
    ...
    <div class="row form-row">
        <div class="col-lg-4 col-sm-4 col-xs-12">
            <form class="resume__form d-flex flex-column gap-4" method="post" action="">
                ...
                <div class="d-flex flex-column gap-2 gap-md-3 mx-0 card p-4 rounded-lg shadow border-0 professional-info">
                    ...
                    <div class="col-md-12 form-group mb-1">
                        ...
                        <input name="name" type="text" class="form-control" id="job-title" placeholder="Job title" required>
                    </div>
                    <div class="col-md-12 form-group mb-1">
        ...
        <div class="col-lg-8 col-sm-8 col-xs-12 mt-4 mt-lg-0">
            <div id="printContent" class="resume-parent card p-0 rounded-lg shadow border-0 overflow-hidden" style="display: flex; flex-direction: row; height: 100%;">
...
function loadInputValues() {
    ...
    // Skills details
    // if (savedSkills == '') {
    //     savedSkills = "Lorem ipsum dolor sit amit is a dummy text..";
    // } else {
    //     savedSkills = localStorage.getItem('savedSkills');
    //     document.getElementById('address').value = savedSkills;
    //     document.getElementById('pro-skills').innerText = savedSkills;
    // }
...
if (file) {
    ...
    reader.onload = function(e) {
        ...
        // Target both containers with unique IDs
        const containers = ['imageContainer', 'imageContainer1'];
        containers.forEach(containerId => {
            const imageContainer = document.getElementById(containerId);
            if (imageContainer) {
                imageContainer.innerHTML = ''; // Clear any previous content
                imageContainer.appendChild(image.cloneNode()); // Clone the image for each container
            }
        });
...
function printSection() {
    ...
    // Write the content and styles to the new window
    printWindow.document.write('<html><head><title>Print</title>' + styles + '</head><body>');
    printWindow.document.write(printContent); // Directly write the content
    printWindow.document.write('</body></html>');
...
<!-- <script>
    ...
    var tagify = new Tagify(input, {
        whitelist: ["HTML", "CSS", "JavaScript", "React", "Vue", "Angular"],
        maxTags: 5,
        dropdown: {
            maxItems: 20,           // Show 20 items in the suggestions dropdown
            enabled: 0,             // Show suggestions as soon as the input is focused
        }
    });

    tagify.on('add', function(e){
        // Get the actual value of the added tag
        var addedTagValue = e.detail.data.value;
        console.log(addedTagValue);
    });

    tagify.on('remove', function(e){
        // Get the actual value of the added tag
        var removedTagValue = e.detail.data.value;
        console.log(removedTagValue);
    });
